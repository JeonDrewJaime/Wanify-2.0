...
namespace E_CommerceSystem
{
    public partial class Cart : KryptonForm
    {
        ...
        private void toReceive_panel_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand selectStatus = new MySqlCommand("SELECT picture_directory, productName, productQuantity, total, orderStatus FROM orders WHERE userID = ('" + UserID + "') AND orderStatus = 'RECEIVE' OR orderStatus = 'DELIVER'", conn);
            ...
            try
            {
                ...
                while (fetchStatus.Read())
                {
                    if (fetchStatus.GetString("orderStatus").Contains("RECEIVE"))
                    {
                        ...
                        cartItems = new DeliveryProcessProducts(UserID, "RECEIVE");
                    ...
                    else
                    {
                        ...
                        cartItems = new DeliveryProcessProducts(UserID, "DELIVER");
        ...
        private void fetchByStatus(string status)
        {
            ...
            MySqlCommand selectByStatus = new MySqlCommand("SELECT picture_directory, productName, productQuantity, total  FROM orders WHERE userID = ('" + UserID + "') AND orderStatus = ('" + status + "')", conn);
            ...
            try
            {
                ...
                while (fetchResults.Read())
                {
                    ...
                    if (status.Equals("PREPARING"))
                    {
                        ...
                        DeliveryProcessProducts cartItems = new DeliveryProcessProducts(UserID, "ordered");
