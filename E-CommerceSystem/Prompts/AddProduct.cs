...
namespace E_CommerceSystem
{
    public partial class AddProduct : KryptonForm
    {
        ...
        private void add_product_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand insertProduct = new MySqlCommand("INSERT INTO products (product_name, price, image, category, description, product_stock) VALUES (@product_name, @price, @image, @category, @description, @product_stock)", conn);
